    ...
    <div className='container max-w-full'>
      <div className="sticky top-0 z-30 grid grid-rows-2 grid-cols-12 grid-flow-col gap-1 h-16 bg-white rounded-b-xl border-b-1">
       <div className="row-span-2 row-start-1 col-start-1  col-span-7 items-center flex justify-start pl-3">
        ...
        <div className="text-[#27374D] text-xl font-medium pl-3">My Coupons</div>
        </div>
      </div>
      ...
      <>
        <Link onClick={()=>{onLinkClick(offer)}} to='/couponinfo'>
          ...
          <div className="w-28 h-32 border-[#D9D9D9] border-2 m-2 rounded-md flex justify-center">
            ...
            <div className="flex pt-2"><div className="text-[#021555] text-opacity-70 text-sm font-normal leading-snug tracking-wide">Code: <span className="text-[#021555] text-opacity-70 text-sm font-semibold leading-snug tracking-wide">{offer.redeem_code}</span></div><div><img src={clipboard} className="pl-1 -mt-1 h-5 z-30" alt="clipboard" onClick={() => {navigator.clipboard.writeText(offer.redeem_code)}}/></div></div>
      ...
      {/*
        ...
        <img src={nyka} className="" alt="nyka" />
        </div>
        </div>
        ...
        <div className="pl-3 pt-2">
        <div className="text-[#021555] text-lg font-medium tracking-wide">Flat 15% Off</div>
        <div className="opacity-60 text-[#021555] text-sm font-normal leading-snug tracking-wide">On min. purchase of ₹1299 </div>
        <div className="flex pt-2 "><div className="text-[#021555] text-opacity-70 text-sm font-normal leading-snug tracking-wide">Code: BONUS15</div><div><img src={clipboard} className="pl-1 -mt-1 h-5" alt="clipboard" /></div></div>
        <div><span className="text-[#021555] text-opacity-70 text-sm font-normal leading-snug tracking-wide">Expiry: </span><span className="text-[#021555] text-opacity-70 text-sm font-extrabold leading-snug tracking-wide">12 Nov 2023</span></div>
        <div className="flex pt-2"><div className="text-red-500 text-lg font-normal font-['Mukta'] leading-snug tracking-wide">View Coupon</div><div><img src={move} className="mt-1.5 pl-1 h-3.5" alt="move" /></div></div>
        </div>
